...
double cephes_igamc(double a, double x) {
  ...
  if ((x < 1.0) || (x < a)) return (1.e0 - cephes_igam(a, x));
...
double cephes_igam(double a, double x) {
  ...
  if ((x > 1.0) && (x > a)) return 1.e0 - cephes_igamc(a, x);
...
double cephes_erf(double x) {
  ...
  if (fabs(x) > 2.2) return 1.0 - cephes_erfc(x);
...
double cephes_erfc(double x) {
  ...
  if (fabs(x) < 2.2) return 1.0 - cephes_erf(x);
  if (x < 0) return 2.0 - cephes_erfc(-x);
